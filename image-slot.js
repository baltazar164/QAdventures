...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:none only while actively reframing (pan/resize) — the
    // rest of the time the image must let touches pass through to the
    // page's normal scroll, or a photo blocks mobile scrolling entirely.
